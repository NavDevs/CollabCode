    ...
    <div className="flex min-h-screen bg-[#050505] text-white font-sans selection:bg-indigo-500/30">
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center items-center p-8 lg:p-20 relative z-10">
        ...
        <div className="w-full max-w-[380px] anim-fade-up">
          {/* Logo */}
          <div className="mb-12">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-white/10 mb-6">
              <BrandMark size={32} />
            </div>
          ...
          <div className="flex flex-col gap-5">
            <button
              ...
              className="group relative flex w-full items-center justify-center gap-3 rounded-xl bg-white text-black font-medium py-3.5 px-4 transition-all duration-300 hover:bg-gray-100 active:scale-[0.98]"
            >
              <svg viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg" className="transition-transform group-hover:scale-110 duration-300">
            ...
            <div className="flex items-center gap-4 my-2">
              ...
              <span className="text-xs font-medium text-gray-500 uppercase tracking-widest">Secure</span>
              <div className="h-[1px] flex-1 bg-white/10"></div>
            </div>
