...
export default function FileTree({ roomId, activePath, setActivePath, openPaths, setOpenPaths, isOwner, refreshKey = 0 }) {
  ...
  return (
    <div 
      style={{ background: 'var(--cc-bg-elevated, #0A0A0A)', borderRight: '1px solid var(--cc-border, rgba(255,255,255,0.05))', display: 'flex', flexDirection: 'column', height: '100%', width: '100%' }}
